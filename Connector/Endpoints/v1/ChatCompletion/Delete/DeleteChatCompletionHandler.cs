...
public class DeleteChatCompletionHandler : IActionHandler<DeleteChatCompletionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteChatCompletionActionOutput>();
            ...
            // var resource = new DeleteChatCompletionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteChatCompletionHandler" };

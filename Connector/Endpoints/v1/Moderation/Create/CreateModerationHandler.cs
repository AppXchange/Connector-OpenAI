...
public class CreateModerationHandler : IActionHandler<CreateModerationAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateModerationActionOutput>();
            // response = await _apiClient.PostModerationDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetModerationDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateModerationActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateModerationHandler" };

...
public class DeleteFileHandler : IActionHandler<DeleteFileAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<DeleteFileActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<DeleteFileActionOutput>();
            ...
            // var resource = new DeleteFileActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteFileHandler" };

...
/// <summary>
/// Action for canceling a batch operation in OpenAI's API
/// </summary>
[Description("Cancels an in-progress batch operation")]
public class CancelBatchAction : IStandardAction<CancelBatchActionInput, CancelBatchActionOutput>
{
    public CancelBatchActionInput ActionInput { get; set; } = new() { BatchId = string.Empty };
    public CancelBatchActionOutput ActionOutput { get; set; } = new()
    {
        Id = string.Empty,
        Object = "batch",
...
public class CancelBatchActionInput
{
...
public class CancelBatchActionOutput
{
    [JsonPropertyName("id")]

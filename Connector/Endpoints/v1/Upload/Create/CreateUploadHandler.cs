...
public class CreateUploadHandler : IActionHandler<CreateUploadAction>
{
    private readonly ILogger<CreateUploadHandler> _logger;

    public CreateUploadHandler(
        ILogger<CreateUploadHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<CreateUploadActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<CreateUploadActionOutput>();
            ...
            // var resource = new CreateUploadActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateUploadHandler" };

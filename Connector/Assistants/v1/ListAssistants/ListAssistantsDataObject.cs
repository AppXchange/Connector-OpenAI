...
/// <summary>
/// Data object that represents a list of OpenAI Assistants in the Xchange system.
/// </summary>
[Description("Represents a list of OpenAI Assistants")]
[PrimaryKey("first_id", nameof(FirstId))]
public class ListAssistantsDataObject
{
    ...
    [Description("The list of assistant objects")]
    [Required]
    public required AssistantListItem[] Data { get; init; }

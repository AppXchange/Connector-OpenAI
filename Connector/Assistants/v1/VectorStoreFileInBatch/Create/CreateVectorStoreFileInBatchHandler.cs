...
public class CreateVectorStoreFileInBatchHandler : IActionHandler<CreateVectorStoreFileInBatchAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateVectorStoreFileInBatchActionOutput>();
            // response = await _apiClient.PostVectorStoreFileInBatchDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetVectorStoreFileInBatchDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateVectorStoreFileInBatchActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(VectorStoreFileInBatchDataObject), CacheChanges = operations.ToArray() }
            };

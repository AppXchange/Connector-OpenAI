...
public class CreateThreadHandler : IActionHandler<CreateThreadAction>
{
    private readonly ILogger<CreateThreadHandler> _logger;
    ...
    {
        var input = JsonSerializer.Deserialize<CreateThreadActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<CreateThreadActionOutput>();
            ...
            // var resource = new CreateThreadActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateThreadHandler" };

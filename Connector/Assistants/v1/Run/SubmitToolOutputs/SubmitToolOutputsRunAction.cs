...
/// <summary>
/// Action to submit outputs for tool calls in a run.
/// </summary>
[Description("Submits outputs for tool calls in a run")]
public class SubmitToolOutputsRunAction : IStandardAction<SubmitToolOutputsRunActionInput, SubmitToolOutputsRunActionOutput>
{
    public SubmitToolOutputsRunActionInput ActionInput { get; set; } = new() 
    { 
        ThreadId = string.Empty,
        RunId = string.Empty,
        ToolOutputs = Array.Empty<ToolOutput>()
    };
    public SubmitToolOutputsRunActionOutput ActionOutput { get; set; } = new() 
    { 
        Id = string.Empty,
        Object = "thread.run",
        CreatedAt = 0,
...
public class SubmitToolOutputsRunActionInput
{
    ...
    [Required]
    public required ToolOutput[] ToolOutputs { get; set; }
...
public class ToolOutput
{
    ...
    [Description("The ID of the tool call in the run that this output is for")]
    [Required]
...
public class SubmitToolOutputsRunActionOutput
{
    [JsonPropertyName("id")]
...
public class Tool
{
    ...
    [Description("The function definition if this is a function tool")]

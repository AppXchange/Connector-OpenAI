...
public class CreateVectorStoreHandler : IActionHandler<CreateVectorStoreAction>
{
    private readonly ILogger<CreateVectorStoreHandler> _logger;

    public CreateVectorStoreHandler(
        ILogger<CreateVectorStoreHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<CreateVectorStoreActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<CreateVectorStoreActionOutput>();
            ...
            // var resource = new CreateVectorStoreActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateVectorStoreHandler" };

namespace Connector;
using Connector.Assistants.v1;
using Connector.Client;
using Connector.Connections;
using Connector.Endpoints.v1;
using ESR.Hosting;
...
public class ConnectorRegistration : IConnectorRegistration<ConnectorRegistrationConfig>, IConfigureConnectorApiClient
{
    ...
    {
        serviceCollection.AddSingleton<IConnectorServiceDefinition, EndpointsV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, EndpointsV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, AssistantsV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, AssistantsV1CacheWriterServiceDefinition>();
    }
